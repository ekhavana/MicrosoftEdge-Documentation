...
Microsoft Edge now supports CSP Level 2. If your site uses [CSP 1.0](http://www.w3.org/TR/CSP1/), it should continue to work with Microsoft Edge, however be aware that the  `child-src` directive has been introduced to supplant `frame-src`. CSP 2 also adds the following:
